...
function renderExamView() {
  ...
  const translationHtml = question.hu
    ? `
      <details class="translation-toggle">
        <summary>Magyar fordítás megmutatása</summary>
        <div class="translation-box">${escapeHtml(question.hu)}</div>
      </details>
    `
    : '';
    ...
    <div class="page">
      ...
      <div class="nav-actions">
        ...
        <button id="next-btn" class="primary-btn">
          ${isLastQuestion ? 'Maradok itt' : 'Következő'}
        </button>
